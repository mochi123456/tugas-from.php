...
<form class="form-horizontal" nama="f1" method="POST" action="table_form.php">
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <input id="prependedtext" name="prependedtext" class="form-control" placeholder="Rizky Ramadhan" type="text" required="">
    </div>
